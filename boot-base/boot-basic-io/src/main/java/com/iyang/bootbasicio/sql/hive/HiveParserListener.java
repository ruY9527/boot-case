...
public interface HiveParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterCreateTablePartitionColumnTypeSpec(HiveParser.CreateTablePartitionColumnTypeSpecContext ctx);
	/**
	 * Exit a parse tree produced by {@link HiveParser#createTablePartitionColumnTypeSpec}.
	 * @param ctx the parse tree
	 */
	void exitCreateTablePartitionColumnTypeSpec(HiveParser.CreateTablePartitionColumnTypeSpecContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterPrecedencePlusExpressionOrDefault(HiveParser.PrecedencePlusExpressionOrDefaultContext ctx);
	/**
	 * Exit a parse tree produced by {@link HiveParser#precedencePlusExpressionOrDefault}.
	 * @param ctx the parse tree
	 */
	void exitPrecedencePlusExpressionOrDefault(HiveParser.PrecedencePlusExpressionOrDefaultContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAlterDatabaseSuffixSetManagedLocation(HiveParser.AlterDatabaseSuffixSetManagedLocationContext ctx);
	/**
	 * Exit a parse tree produced by {@link HiveParser#alterDatabaseSuffixSetManagedLocation}.
	 * @param ctx the parse tree
	 */
	void exitAlterDatabaseSuffixSetManagedLocation(HiveParser.AlterDatabaseSuffixSetManagedLocationContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAlterDataConnectorStatementSuffix(HiveParser.AlterDataConnectorStatementSuffixContext ctx);
	/**
	 * Exit a parse tree produced by {@link HiveParser#alterDataConnectorStatementSuffix}.
	 * @param ctx the parse tree
	 */
	void exitAlterDataConnectorStatementSuffix(HiveParser.AlterDataConnectorStatementSuffixContext ctx);
	/**
	 * Enter a parse tree produced by {@link HiveParser#alterDataConnectorSuffixProperties}.
	 * @param ctx the parse tree
	 */
	void enterAlterDataConnectorSuffixProperties(HiveParser.AlterDataConnectorSuffixPropertiesContext ctx);
	/**
	 * Exit a parse tree produced by {@link HiveParser#alterDataConnectorSuffixProperties}.
	 * @param ctx the parse tree
	 */
	void exitAlterDataConnectorSuffixProperties(HiveParser.AlterDataConnectorSuffixPropertiesContext ctx);
	/**
	 * Enter a parse tree produced by {@link HiveParser#alterDataConnectorSuffixSetOwner}.
	 * @param ctx the parse tree
	 */
	void enterAlterDataConnectorSuffixSetOwner(HiveParser.AlterDataConnectorSuffixSetOwnerContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link HiveParser#precedenceSimilarExpressionQuantifierPredicate}.
	 * @param ctx the parse tree
	 */
	void enterPrecedenceSimilarExpressionQuantifierPredicate(HiveParser.PrecedenceSimilarExpressionQuantifierPredicateContext ctx);
	/**
	 * Exit a parse tree produced by {@link HiveParser#precedenceSimilarExpressionQuantifierPredicate}.
	 * @param ctx the parse tree
	 */
	void exitPrecedenceSimilarExpressionQuantifierPredicate(HiveParser.PrecedenceSimilarExpressionQuantifierPredicateContext ctx);
	/**
