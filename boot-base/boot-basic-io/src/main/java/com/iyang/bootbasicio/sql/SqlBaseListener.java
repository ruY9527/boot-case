...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#intervalUnit}.
	 * @param ctx the parse tree
	 */
	void enterIntervalUnit(SqlBaseParser.IntervalUnitContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#intervalUnit}.
	 * @param ctx the parse tree
	 */
	void exitIntervalUnit(SqlBaseParser.IntervalUnitContext ctx);
	/**
