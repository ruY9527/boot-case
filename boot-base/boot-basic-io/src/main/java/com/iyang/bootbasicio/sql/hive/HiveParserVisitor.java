...
public interface HiveParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitCreateTablePartitionColumnTypeSpec(HiveParser.CreateTablePartitionColumnTypeSpecContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterDatabaseSuffixSetManagedLocation(HiveParser.AlterDatabaseSuffixSetManagedLocationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterDataConnectorSuffixProperties(HiveParser.AlterDataConnectorSuffixPropertiesContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrecedenceSimilarExpressionQuantifierPredicate(HiveParser.PrecedenceSimilarExpressionQuantifierPredicateContext ctx);
	/**
